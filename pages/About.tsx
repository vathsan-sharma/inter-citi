      ...
      <section className="bg-slate-950 py-32 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-20 relative z-10">
          <motion.h1 
            ...
            className="hero-title text-5xl md:text-8xl mb-8 uppercase"
          >
            Our <br/> Heritage
          </motion.h1>
          <motion.p 
          ...
          >
            Intercity Logistics Canada is an industry-specific provider specializing in freight movement within Canada since 1990.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-t border-slate-100 pt-16">
            <ValueItem icon={<Users className="w-6 h-6" />} title="Responsiveness" body="An on-going commitment to responding to client needs and market fluctuations." />
            <ValueItem icon={<Target className="w-6 h-6" />} title="Flexibility" body="Innovative solutions customized to offer maximum reliability and cost-effectiveness." />
            <ValueItem icon={<Shield className="w-6 h-6" />} title="Safety" body="Rigid service inspections and regular driver safety updates for a flawless record." />
            <ValueItem icon={<CheckCircle className="w-6 h-6" />} title="Accuracy" body="Timely and accurate delivery supported by the latest real-time tracking technology." />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div>
              ...
              <div className="space-y-6 text-slate-600 leading-relaxed">
                <p>Kula Sellathurai, President of Intercity Logistics Canada, is a serial entrepreneur who established the company in 1990 after identifying a critical gap in industry-specific logistics.</p>
                ...
                <p>Under his leadership, Intercity has grown from a local provider to a Canadian mainstay, defined by the core values of community, integrity, and relentless service.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <p className="text-xl text-slate-500 mb-12 leading-relaxed">
                Our drivers are the key to on-time quality service. We enforce a high standard, requiring professional certification and extensive experience in Canadian logistics.
              </p>
              <ul className="space-y-8">
                ...
                <li className="flex gap-4">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-slate-500">Regular updates on safety protocols, accident prevention, and emergency response guidelines.</p>
                   </div>
                </li>
              </ul>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <img src="https://images.unsplash.com/photo-1591768793355-74d7c869c3b7?auto=format&fit=crop&q=80&w=600" className="rounded-2xl" alt="Fleet Safety" />
              <img src="https://images.unsplash.com/photo-1501700493717-9c99da9ff053?auto=format&fit=crop&q=80&w=600" className="rounded-2xl mt-12" alt="Fleet Modernization" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Our 30,000 sq ft facility in Scarborough is climate-controlled and monitored 24/7, serving as a strategic hub for Just-in-Time distribution.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <FeatureBox title="Scarborough Hub" body="Strategically located near major shipping lanes for rapid deployment." />
          </div>
        </div>
      </section>
    </div>
...
const ValueItem: React.FC<{icon: React.ReactNode, title: string, body: string}> = ({ icon, title, body }) => (
  <div>
